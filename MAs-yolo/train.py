...
if __name__ == "__main__":
    ...
    #       在终端中输入    CUDA_VISIBLE_DEVICES=0,1,2 python train.py
    #   DDP模式：
    #       设置            distributed = True
    #       在终端中输入    CUDA_VISIBLE_DEVICES=0,1,2 python -m torch.distributed.launch --nproc_per_node=3 train.py
    #---------------------------------------------------------------------#
    distributed     = False
    #---------------------------------------------------------------------#
    ...
    #----------------------------------------------------------------------------------------------------------------------------#
    model_path      = 'model_data/yolov8_x_backbone_weights.pth'
    #------------------------------------------------------#
    ...
    if model_path != '':
        ...
        print("Pretrained dict keys:", pretrained_dict.keys())
